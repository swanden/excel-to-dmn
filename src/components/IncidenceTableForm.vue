<template>
    <div>
        ...
        <result
                v-if="xml !== ''"
                :xml="xml"
                :endpoint="'http://localhost:3000/get_incidence_table_file'"
        ></result>
    </div>
</template>
...
<script>
    ...
    import SimpleParamData from './SimpleParamData';
    ...
    export default {
        ...
        methods: {
            ...
            submitForm() {
                ...
                axios.post( 'http://localhost:3000/get_incidence_table_xml',
                    formData,
                    {
                        headers: {
